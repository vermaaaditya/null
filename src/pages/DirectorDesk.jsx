        ...
        <div className="director-content">
          ...
          <div className="director-card">
            <div className="card-image">
              <img 
                src="https://via.placeholder.com/400x500/1a4d8f/ffffff?text=Director" 
                alt="Director" 
              />
              <div className="image-overlay"></div>
            </div>
            <div className="card-info">
              <h3 className="director-name">Dr. Rajesh Kumar Sharma</h3>
              <p className="director-designation">Director & Professor</p>
              <p className="director-credentials">
                Ph.D. (IIT Delhi) | M.Tech | B.E.
              </p>
              <div className="director-contact">
                <p>📧 director@gec.edu.in</p>
                <p>📞 +91-XXX-XXXXXXX</p>
              </div>
            </div>
          </div>
