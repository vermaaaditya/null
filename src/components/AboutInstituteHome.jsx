          ...
          <div className="home-about-grid">
            ...
            <div className="home-about-content">
              <p className="lead-text">
                ...
                Panchkula) Sector-26. The institute offers six undergraduate programs: Computer Science and Engineering
                (Core), Computer Science and Engineering (AI &amp; ML), Computer Science and Engineering (Cyber Security),
                Robotics &amp; Automation, Electrical Engineering, and Electronics Engineering (VLSI Design).
              </p>
